...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>monitor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxHiltNavigationComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v110</b> with <b>androidx.hilt:hilt-navigation-compose</b> coordinates and
         * with version reference <b>hiltNavigationComposeVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV110() {
            return create("androidx.hilt.navigation.compose.v110");
        }
    ...
    public static class AndroidxMaterial3LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v110</b> with <b>androidx.compose.material3:material3</b> coordinates and
         * with version reference <b>material3Version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV110() {
            return create("androidx.material3.v110");
        }
    ...
    public static class HiltAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>googleHiltAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompiler() {
        ...
        /**
         * Dependency provider for <b>v2381</b> with <b>com.google.dagger:hilt-android</b> coordinates and
         * with version reference <b>hiltAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV2381() {
            return create("hilt.android.v2381");
        }

        /**
         * Dependency provider for <b>v241</b> with <b>com.google.dagger:hilt-android</b> coordinates and
         * with version reference <b>googleHiltAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV241() {
            return create("hilt.android.v241");
        }

        /**
         * Dependency provider for <b>v248</b> with <b>com.google.dagger:hilt-android</b> coordinates and
         * with version reference <b>googleHiltAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV248() {
            return create("hilt.android.v248");
        }
    ...
    public static class HiltCompilerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2381</b> with <b>com.google.dagger:hilt-compiler</b> coordinates and
         * with version reference <b>hiltCompiler</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV2381() {
            return create("hilt.compiler.v2381");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>daggerCompiler</b> with value <b>2.51.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleHiltAndroid</b> with value <b>2.48</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleHiltAndroidVersion</b> with value <b>2.41</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleHiltAndroidVersion() { return getVersion("googleHiltAndroidVersion"); }

        /**
         * Version alias <b>hiltAndroid</b> with value <b>2.44</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltAndroidVersion</b> with value <b>2.38.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltCompiler</b> with value <b>2.38.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hiltNavigationComposeVersion</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>material3Version</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>monitor</b> with value <b>1.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMonitor() { return getVersion("monitor"); }
